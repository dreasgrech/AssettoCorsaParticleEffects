...
local optionsCollection_beforeDoD = {
    ...
    { name = StorageManager.Options.Sparks_Velocity, default=vec3(0,1,0), min=-100, max=100, label='Velocity', tooltip='The velocity applied to the sparks' },
    ...
    { name = StorageManager.Options.Smoke_Velocity, default=vec3(0,1,0), min=-100, max=100, label='Velocity', tooltip='The velocity applied to the smoke' },
...
local storageTable = {
    ...
    flame_position = StorageManager.options_default[StorageManager.Options.Flame_Position]:clone(),
    flame_positionOffset = StorageManager.options_default[StorageManager.Options.Flame_PositionOffset]:clone(),
    flame_velocity = StorageManager.options_default[StorageManager.Options.Flame_Velocity]:clone(),
    flame_color = StorageManager.options_default[StorageManager.Options.Flame_Color]:clone(),
    ...
    sparks_position = StorageManager.options_default[StorageManager.Options.Sparks_Position]:clone(),
    sparks_positionOffset = StorageManager.options_default[StorageManager.Options.Sparks_PositionOffset]:clone(),
    sparks_velocity = StorageManager.options_default[StorageManager.Options.Sparks_Velocity]:clone(),
    sparks_color = StorageManager.options_default[StorageManager.Options.Sparks_Color]:clone(),
    ...
    smoke_position = StorageManager.options_default[StorageManager.Options.Smoke_Position]:clone(),
    smoke_positionOffset = StorageManager.options_default[StorageManager.Options.Smoke_PositionOffset]:clone(),
    smoke_velocity = StorageManager.options_default[StorageManager.Options.Smoke_Velocity]:clone(),
    smoke_color = StorageManager.options_default[StorageManager.Options.Smoke_Color]:clone(),
